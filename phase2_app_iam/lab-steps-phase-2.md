...
We do not need any additional setup for now, because now the communication between the internal and DMZ server's is open. We can prove this by attempting to ping/curl the reverse proxy.
...
- Finally, ensure you assign the correct IP address of your external interface for the firewall. For my case, the firewall sets on 192.168.33.6.
<p align="center">
...
To install node, you should follow the guide that works for your environment[here](https://nodejs.org/en/download/).
